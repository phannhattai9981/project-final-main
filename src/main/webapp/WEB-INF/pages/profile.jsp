    ...
    <div class="formbold-main-wrapper">
        ...
        <form action="updateProfile" method="post" encType="multipart/form-data" modelAttribute="editProfile">
            ...
            <div class="formbold-input-group">
                ...
                <input name="email" value="${editProfile.email}" type="text" class="form-control" readonly/>
            </div>

            <div class="formbold-input-group">
              <input name="id" value="${editProfile.id}" class="form-control" type="hidden" readonly/>
            </div>

            <div class="formbold-input-group">
              <label for="email" class="formbold-form-label"> Họ Tên  </label>
              <input name="fullName" value="${editProfile.fullName}" type="text" class="form-control"/>
            </div>

            <div class="formbold-input-group">
                <label for="age" class="formbold-form-label"> Avatar </label>
                <input name="photo" value="${editProfile.avatar}" type="file" class="form-control"/>
            </div>

            <div class="formbold-input-group">
                <label for="age" class="formbold-form-label"> Số điện thoại </label>
                <input name="phone" value="${editProfile.phone}" type="number" class="form-control"/>
            </div>
