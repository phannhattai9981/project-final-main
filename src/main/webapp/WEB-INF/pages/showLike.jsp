...
<c:forEach var="like" items="${like}">
    <tr class="alert" role="alert">
        <th scope="row" style="padding-top:15px;">${like.product.name}</th>
        <th scope="row" style="padding-top:15px;"><fmt:formatNumber value="${likes.orderDetails.price}" pattern="#,##0" /></th>
    </tr>
</c:forEach>
										</tbody>
									</table>
